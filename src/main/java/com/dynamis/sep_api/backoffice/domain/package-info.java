/**
 * Modulo Backoffice - Camada de Dominio.
 *
 * <p>Responsabilidade do modulo: Filas operacionais, pendencias, excecoes, comentarios e reprocessos manuais.
 *
 ...
 */
package com.dynamis.sep_api.backoffice.domain;
