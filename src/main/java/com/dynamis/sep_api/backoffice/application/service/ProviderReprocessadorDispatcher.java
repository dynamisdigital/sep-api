 ...
 * {@link UnsupportedOperationException} — sera mapeado em 400 pelo controller (Task 14.7).
 */
@Component
public class ProviderReprocessadorDispatcher implements ProviderReprocessadorPort {
    ...
    public ResultadoReprocesso reprocessar(TipoChamadaProvider tipo, UUID entidadeId) {
        ...
        if (strategy == null) {
            throw new UnsupportedOperationException("tipo de reprocesso nao suportado: " + tipo);
        }
