-- =============================================================================
-- V59 — Sprint 31 Task 31.5: amplia chk_audit_seguranca_tipo com eventos da
-- gestao assistida de chaves Pix da conta operacional (Epic 15).
-- =============================================================================
-- Adiciona 2 tipos:
--   PIX_CHAVE_CADASTRADA — chave cadastrada no provider e persistida (ATIVA)
--   PIX_CHAVE_REMOVIDA   — transicao efetiva ATIVA -> INATIVA (remocao logica)
--
-- Forward-only. Mantem todos os tipos anteriores (base: V57).
-- =============================================================================
