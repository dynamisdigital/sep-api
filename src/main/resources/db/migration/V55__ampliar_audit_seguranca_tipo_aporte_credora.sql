-- =============================================================================
-- V55 — Sprint 29 Task 29.3: amplia chk_audit_seguranca_tipo com eventos do
-- aporte assistido da credora (Epic 15).
-- =============================================================================
-- Adiciona 3 tipos:
--   CREDORA_APORTE_REGISTRADO — aporte assistido registrado (financeiro/admin)
--   CREDORA_APORTE_LIQUIDADO  — aporte liquidado na reconciliacao (Task 29.5)
--   CREDORA_APORTE_FALHOU     — aporte com falha terminal na reconciliacao
--
