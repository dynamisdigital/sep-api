-- =============================================================================
-- V50 — Sprint 20 Task 20.5: amplia chk_audit_seguranca_tipo com eventos de
-- desembolso Pix (Epic 15).
-- =============================================================================
-- Adiciona 3 tipos da trilha auditavel reforcada do desembolso assistido
-- (CMN 4.656/2018 — operacao financeira):
--   PIX_TRANSFERENCIA_SOLICITADA — desembolso aceito pelo provider
--   PIX_TRANSFERENCIA_CONCLUIDA  — desembolso liquidado
--   PIX_TRANSFERENCIA_FALHOU     — rejeicao do provider ou falha tecnica
--
-- Forward-only. Detalhes JSON carregam apenas ids tecnicos + valor + status;
-- a chave Pix em claro NUNCA entra no audit log (apenas mascara, quando muito).
-- =============================================================================
