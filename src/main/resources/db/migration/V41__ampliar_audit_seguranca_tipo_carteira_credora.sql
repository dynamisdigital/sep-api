-- =============================================================================
-- V41 — Sprint 17 Task 17.6: amplia chk_audit_seguranca_tipo com eventos de
-- oportunidades e carteira da credora (Epic 10).
-- =============================================================================
-- Adiciona 3 tipos:
--   CREDORA_INTERESSE_REGISTRADO — credora manifestou interesse numa oportunidade
--   CREDORA_INTERESSE_CANCELADO  — credora cancelou interesse
--   CREDORA_OPERACAO_ASSOCIADA   — operacao financiada associada a carteira (assistida)
--
