-- =============================================================================
-- V46 — Sprint 19 Task 19.6: amplia chk_audit_seguranca_tipo com eventos de
-- webhook Pix (foundation Epic 15).
-- =============================================================================
-- Adiciona 3 tipos:
--   PIX_WEBHOOK_RECEBIDO    — webhook Pix registrado no outbox (idempotente)
--   PIX_WEBHOOK_PROCESSADO  — webhook Pix processado com sucesso
--   PIX_WEBHOOK_FALHOU      — falha de processamento do webhook (reprocesso futuro)
--
-- Forward-only. Mantem todos os tipos anteriores. Eventos de provider de
-- desembolso/escrow (PIX_TRANSFERENCIA_SOLICITADA, ESCROW_*_PROVIDER_CRIADA)
-- ficam para as Sprints 20/21, quando houver use case que os dispare.
-- =============================================================================
